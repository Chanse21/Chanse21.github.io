...
public class Laser : MonoBehaviour 
	{
		public float boomAmt = 20f; //variable to change how much force to add **DEFAULTS TO ZERO (NO FORCE)**
	public AudioSource popSource;
    public GameObject[] targets;

    public float numberTarget = 6f;
	...
	void Update()
		{
			...
			Debug.DrawRay(laser.origin, laser.direction, Color.blue);
        ...
        if (Physics.Raycast(laser, out hit, 10000000f) && Input.GetMouseButton(0)) //(which ray, which raycasthit, how far to send it)
			{
